...
const SignUp = () => {
  ...
  async function sendData(e) {
    ...
    try {
      const res = await axios.post('https://home-stylist-be.vercel.app/api/register', { 
  ...
  return (
    <div className='signin signup'>
      ...
      <div className='new-to-homestylist'>
        <p><span>Already registered at HomeStylist?</span></p>
        <NavLink to='/login'>
